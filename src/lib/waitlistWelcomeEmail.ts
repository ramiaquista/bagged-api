...
<body>
  <div class="wrapper">
    <div class="container">
      <!-- Hero with banner -->
      <div class="hero">
        <img src="https://bagged-api-production.up.railway.app/brand/logo-banner.png" alt="Bagged — Track your P&L across all chains" style="width: 100%; height: auto; display: block;">
      </div>
